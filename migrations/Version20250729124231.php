 ...
 */
final class Version20250729124231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE opportunity CHANGE probability probability INT DEFAULT NULL, CHANGE close_date deadline DATE NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE opportunity CHANGE probability probability INT NOT NULL, CHANGE deadline close_date DATE NOT NULL');
    }
}
